...
public class BlackKnight {
	...
	public BlackKnight(String name) {
		...
		// HINT: use "this.name" to access name of knight which otherwise is shadowed by parameter of constructor, which is also called "name"
